...
export const handlerAppsUsers = [
  // Get Users Details
  http.get(('/api/apps/users'), (req, res, ctx) => {
  ...
  http.get(('/api/apps/users/:id'), (req, res, ctx) => {
  ...
  // Delete User
  http.delete(('/api/apps/users/:id'), (req, res, ctx) => {
    const userId = Number(req.params.id)
  ...
  // 👉 Add user
  http.post(('/api/apps/users'), async (req, res, ctx) => {
