...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'apps-ecommerce-customer-view-id': RouteRecordInfo<'apps-ecommerce-customer-view-id', '/apps/ecommerce/customer/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
