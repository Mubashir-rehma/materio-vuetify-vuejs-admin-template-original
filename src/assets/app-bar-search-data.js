...
export default [
  { header: 'Pages' },
  { title: 'Alert', to: { name: 'components-alert' }, icon: mdiAlert },
  { title: 'Avatar', to: { name: 'components-avatar' }, icon: mdiAccount },
  { title: 'Badge', to: { name: 'components-badge' }, icon: mdiTag },
  { title: 'Button', to: { name: 'components-button' }, icon: mdiAlphaBBox },
  ...
  { title: 'Snackbar', to: { name: 'components-snackbar' }, icon: mdiBell },
  ...
  { title: 'File Input', to: { name: 'form-file-input' }, icon: mdiAlphaTBox },
  ...
  { title: 'Textarea', to: { name: 'form-textarea' }, icon: mdiAlphaTBox },
  { title: 'Textfield', to: { name: 'form-textfield' }, icon: mdiAlphaTBox },
  ...
  { title: 'Rating', to: { name: 'form-rating' }, icon: mdiStar },
  { title: 'Apex Chart', to: { name: 'apex-chart' }, icon: mdiStar },
