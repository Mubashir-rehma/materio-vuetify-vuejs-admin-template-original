<template>
  <v-row>
    ...
    <v-col cols="6">
      ...
      >
        <v-spacer></v-spacer>
        <v-icon>{{ mdiWifiStrength4 }}</v-icon>
        <v-icon>{{ mdiSignalCellularOutline }}</v-icon>
        <v-icon>{{ mdiBattery }}</v-icon>
        <span>12:30</span>
      </v-system-bar>
    ...
    <v-col cols="6">
      ...
      <v-navigation-drawer permanent>
        ...
        >
          <v-list-item
            v-for="item in navigationDrawer"
            :key="item.title"
            link
          >
            <v-list-item-icon>
